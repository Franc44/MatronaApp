...
/*export async function getServerSideProps({ req, res }) {
  ...
  {
    console.log('No estas loggeado paps');
    return {
      props: {}
    }
  }
      ...
      authSession(data).then(res => {
        if(res.status < 400) {
          ...
          Modal.fire({
            ...
            html: (
              <div className="w-100 d-flex flex-column text-center align-items-center">
                <span className="lead">Verifique que el usuario y contraseña sean los correctos, por favor vuelve a intentarlo, si el problema persiste, reestablezca su contraseña o contactese con soporte técnico.</span>
